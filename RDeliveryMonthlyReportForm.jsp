...
<%-- <jsp:include page="sessionBoth.jsp">	
   <jsp:param name="formName" value="RDeliveryMonthlyReportForm.jsp" />	
</jsp:include>
 --%>
 
<%@ page errorPage="ReportErrorPage.jsp?page=RDeliveryMonthlyReportForm.jsp" %>
...
<script>
	function checkField(){
		...
		var check1=document.myform.hchckall.value;
		...
		document.myform.action="RDeliveryMonthlyReport.jsp?Exp=0";
