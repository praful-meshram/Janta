...
<%@ page errorPage="ErrorPage.jsp?page=PakegingForm.jsp" %>
...
<script type="text/javascript" src="js/Pakeging.js"></script>
<script src="js/DataTablejquery-1.10.2.min.js"></script>
				...
				<tr>
					<td style="35%">
						<table id="search_table">
							...
							<tr>
								<th  align="left">Enter Bachka Name :</th>
							...
							<tr>
								...
								<td></td>
								<td>
									<input type="button" style="width: 100%;" accesskey="s" value="Search<Alt+s>" class="menulired" onclick="funSearchBachka();"  style="width:48%;"/> 
								</td>
							</tr>
    					</table>
    				</td>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="loss_in_breakdown"
					value="0" size="3" disabled="disabled" readonly="readonly"/>kg.</td>
			...
			<div id="roundedDiv1" style="margin-top:-200px;margin-left:50%;width : 50%;padding-top:10px;height: 183px;">
				<table id="serch_div_table_main">
					...
					<tr style="width:100%;height:65%;">
						<td style="width:100%;height:65%;">
							<div id="selectedItemListDiv" style="height:100%;border:1px solid black;">
								<div id="inner2" style="height:150px;width:100%; overflow-y:scroll;">
									<table class="genericTbl1" style="font-size: 80%;width:100%;margin-right: -17px;height150px;" id="selectedItemsTable" border="1">
