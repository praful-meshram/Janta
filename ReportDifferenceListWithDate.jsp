...
<%@ page errorPage="ReportErrorPage.jsp?page=ReportDifferenceListWithDate.jsp" %>
...
%>
		...
		<div id="reportDiff" style="display: none;">			
<%
			int i=0;
...
function Pass(){
		document.myform.action="ReportDifferenceListWithDate.jsp?Exp=1";
	    document.myform.submit();
}
...
$(document).ready(
	function(){
		...
		var gsonObject = jQuery.parseJSON($('#reportDiff').html());
            ...
            {	
                ...
                [
	                ...
	                {"text":"Adv Amt","datafield":"advanceAmt",width:'150px'},
                ...
                [
	                {"text":"Area","datafield":"area",width:'150px'},{"text":"Order","datafield":"orderNo" ,width:'150px'},
	                {"text":"Customer Name","datafield":"custName",width:'150px'},{"text":"Phone","datafield":"Phone",width:'150px'},
	                {"text":"Order Date","datafield":"order_date",width:'150px'},{"text":"Items","datafield":"totalItems",width:'150px'},
			...
			$("#saveToExcel").click(function () {
                //document.myform.exportdata.value = $("#reportDiffGrid").html();
                $("#reportDiffGrid").jqxGrid('exportdata', 'xls', 'Diffrence Report');    
                  
                //document.myform.action="GridToExcel.jsp";
               // document.myform.submit();     
            });	
	}
);
