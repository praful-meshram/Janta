...
<%@ page errorPage="ReportErrorPage.jsp?page=RDeliveryDailyReportForm.jsp" %>
...
var flag=true;
	...
	function checkField(){
	   ...
	   if (flag==false){
	       ...
	       document.myform.action="RDeliveryDailyReport.jsp?Exp=0"+url;
	   		
 		}
 		else{
 			//document.myform.action="RDeliveryDailyReportSummary.jsp?Exp=0";
 			document.myform.action="RDeliveryDailyReportSummary.jsp?Exp=0"+url;
	   	}
	...
	<div id="div4" style="VISIBILITY:hidden" align="center">		
		<table border="0" align="center">		
				...
				<tr>
					...
					<tr></tr>
					<tr>
							<td><b>From<font color="blue">D</font>ate</b></td><td><div id="range1"></div></td>
							<td><font color="blue"> T</font>oDate</td><td><div id="range2"></td>
						</tr>
						<tr></tr>
					<tr></tr>
