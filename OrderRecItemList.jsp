...
<%--  	<jsp:include page="sessionBoth.jsp">	
   		<jsp:param name="formName" value="OrderRecItemList.jsp" />	
	</jsp:include>
 --%>
<%@ page errorPage="ErrorPage.jsp?page=OrderRecItemList.jsp" %>
...
<jsp:plugin type="applet" code="applet.CreateNewOrder.class" codebase="applet/classes/" name="CreateOrder"  width="100%" height="300" >
   <jsp:params>
