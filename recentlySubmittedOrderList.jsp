...
<%-- <jsp:include page="sessionBoth.jsp">	
   <jsp:param name="formName" value="recentlySubmittedOrderList.jsp" />	
</jsp:include>
 --%>
 
<%@ page errorPage="ErrorPage.jsp?page=recentlySubmittedOrderList.jsp" %>
...
%>    	
    	<table   border="1" class="item3" style="width: 100%; border-collapse: collapse;" cellspacing=0 cellpadding=0 bordercolor=black>
    	<tr><th colspan="8" style="padding: 3px 0px 3px 5px;"><center><b>Recently Submitted orders</b></center></th></tr>
			<tr align="center"> 
...
%>	
			</td><td><a href="print_order1.jsp?orderNo=<%=rs.getString(1)%>&backPage=customer_detailsForm.jsp">Print</tr>
<%		
		}	    	  
    	rs.close();
		stat.close();
