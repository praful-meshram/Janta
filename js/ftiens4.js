...
{ 
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<a class=treenav1-legal  style='color=#333399' href='" + this.hreference + "' TARGET=\"basefrm\" "
	else
	  docW = docW + "<a  class=treenav1-legal style='color=#333399' href='" + this.hreference + "' TARGET=_top "
