...
<form name="myform" method="post" action="RADeliveryDailyReportDetailsAllPrint.jsp">
<table border="0">
<%
	...
	c.VlistDeliveryDailyReportAllDetails(); 
	while(c.rs.next()) {
	...
	<tr>
		<td colspan=4><fieldset><legend>Hawala</legend><table align="left">					
				<tr>
					...
					<td><b>Total <font color="blue">O</font>rders</b></td><td><b>:</b></td><td><a  href="ReportDifferenceListWithAllDateAnalysis.jsp?Exp=0,&pageType=<%=pageType%>&order_type=ALL&payment_type=H" ><%=htotal_orders%></a></td>
				</tr>
				<tr>
				...
				<tr>
					<td><b>Diff. <font color="blue">A</font>mount</b></td><td><b>:</b></td><td><a  href="ReportDifferenceListWithAllDateAnalysis.jsp?Exp=0,&pageType=<%=pageType%>&order_type=PMTDIFF&payment_type=H" >
<%			
...
%>    	 	
			...
			<td colspan=4><fieldset><legend>Cash/Cheque</legend><table align="left">					
				<tr>
					<td><b><font color="blue">D</font>ate:</b>ALL</td><td></td>
					<td><b>Total <font color="blue">O</font>rders:</b><a  href="ReportDifferenceListWithAllDateAnalysis.jsp?Exp=0,&pageType=<%=pageType%>&order_type=ALL&payment_type=CACHQ" ><%=catotal_orders%></a></td>
			</tr>
			<tr>
			...
			<tr>
				<td><b>Diff.<font color="blue">A</font>mount</b></td><td><b>:</b></td><td><a  href="ReportDifferenceListWithAllDateAnalysis.jsp?Exp=0,&pageType=<%=pageType%>&order_type=PMTDIFF&payment_type=CACHQ" >
<%			
...
%>    	 	
			...
			<tr>
				<td><b><font color="blue">D</font>ate:</b>ALL</td><td></td>
				<td><b>Total <font color="blue">O</font>rders:</b><a  href="ReportDifferenceListWithAllDateAnalysis.jsp?Exp=0,&pageType=<%=pageType%>&order_type=ALL&payment_type=CR" ><%=ctotal_orders%></a></td>
			</tr>
			<tr>
			...
			<tr>
				<td><b>Diff.<font color="blue">A</font>mount</b></td><td><b>:</b></td><td><a  href="ReportDifferenceListWithAllDateAnalysis.jsp?Exp=0,&pageType=<%=pageType%>&order_type=PMTDIFF&payment_type=CR" >
<%			
...
<input type="submit" name="print" value="Print" align="right"></td></tr>
