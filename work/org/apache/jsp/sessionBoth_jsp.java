...
public final class sessionBoth_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String utype="";
	...
	if(session.getAttribute("user_type_code") !=null){
      ...
      out.write("\t\t\t\t\t");
      if (true) {
        _jspx_page_context.forward("HomeForm.jsp?exp=5&formname=<%=formName%>");
        return;
      }
      out.write('\n');
					}
      ...
      out.write("\t\t\t\t\t");
      if (true) {
        _jspx_page_context.forward("HomeForm.jsp?exp=5");
        return;
      }
      out.write('\n');
      ...
      out.write("\t\t\t\t\t");
      if (true) {
        _jspx_page_context.forward("LoginForm.jsp?Exp=5");
        return;
      }
      out.write('\n');
