<html>
	...
	<script type="text/javascript" src="js/MixtureMapping.js"></script>
	...
	<link rel="stylesheet" type="text/css" href=css/MixtureMapping.css />
	...
	<%@ page errorPage="ErrorPage.jsp?page=MixtureMappingForm.jsp" %>
...
<body style="background-color: transparent;">
		...
		<table style="width: 100%;height: 15px;">
			...
			<td style="text-align: center;"><h3 align="center">Mixture Mapping</h3></td>
		...
		<div id="outer1" style="margin-top:0px;height: 200px; background-color: #BEF781;">
				...
				<table  border="0" style="width: 100%;height: 100%;margin-top: 0px;border-width: 3px;">
			
				<tr  style="height: 30%; margin-top: 0px;">
			
					<td style="margin-top: 0px;width: 25%;"  >
<!-- 				<div id="searchBachkaId"> -->
					...
					<tr>
					<th align="left">Enter Mixture Name</th><th><input type="text" name="bachkaName" tabindex="1" class="textfield"s></th>
					</tr>
					<tr>
				...
				<td style="width: 75%;" id="displayBachkaIdCol">
					<div id="displayBachkaId" style="height: 170px;margin-top: 20px;"></div>
			...
			<div id="outer2" style=" margin-top:4px; height: 380px;background-color: #BEF781;">
					<table style="height: 10%;width: 100%;" border="0">
						<tr style="margin-top: 2px;">
							...
							<p style="font-size: 15px;font-family:'Times New Roman', Times, serif;"><b>Selected Mixture :</b></p>
							...
							<table style="height: 100%;width: 100%;border-collapse: collapse;" border="0" id="selectedBachkaTable">
								<thead style="max-height: 4px;font-family:'imes New Roman',Times,serif;">
					...
					<td rowspan="2" style="width: 55%;margin-left: 15px;margin-top: 5px;"  id="itemByGroupCodeCol">
						<!-- <div id="itemByGroupCode" class="itemByGroupCode" style="width: 100%; height:100%;overflow:auto;"></div>
						 --><table border="0" style="height: 100%;width: 100%;">
						<tr>
							<tr><td style="height: 10%;"><div id="searchItemByGroupCode" style="width: 100%;height: 100%;"></div></td></tr>
							<tr style="margin-top: 10px;"><td style="width: 100%;height: 90%;"><div id="itemByGroupCode" class="itemByGroupCode" style="width: 100%; height:100%;"></div></td></tr>
						</table>
					</td>
					</tr>
					<tr>
						<td style="width: 30%;height: 170px;overflow: auto;">
							<table style="height: 100%;width: 100%;">
								<tr><td><p style="font-size: 15px;"><b>Mapped Item :</b></p></td></tr>
								<tr><td><div id="addToBachka" style="height: 170px;border:2px solid #98bf21;overflow: auto;"></td></tr>
							</table>
