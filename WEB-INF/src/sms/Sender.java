...
public class Sender implements Runnable  {
  ...
  private String csca="+919021000500"; // the message center
  private SerialParameters defaultParameters= new SerialParameters ("COM6",115200,0,0,8,1,0);
  public int step;
  public int status=-1;
  ...
  public int send () throws Exception{
    ...
    System.out.println(" New Serail connection done");
    mySerial.openConnection();
    System.out.println(" Serail connection Opened");
