   ...
   */
   public void openConnection() throws SerialConnectionException {
	...
	try {
		 ...
		 ports.nextElement();
//		 System.out.println("ports: " + ports.hasMoreElements());
...
//		      System.out.println(port.getName() + ": " + type);
         ...
         System.out.println("PPPPPPPP=>"+parameters.getPortName());
...
//	    System.out.println("portId"+portId);
	...
	// portId.addPortOwnershipListener(new MyResolver());
	    
	} catch (Exception e) {
		System.out.println("Error:  "+ e);
		 throw new SerialConnectionException("Error");
   	}
